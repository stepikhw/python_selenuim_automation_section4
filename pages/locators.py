...
class ProductPageLocators:
    BASKET_TOTAL_IN_THE_INNER_ALERT = (By.CSS_SELECTOR, "div[class*=\"alert\"]:last-child div[class*=\"alertinner\"] strong")
    PRODUCT_NAME_IN_THE_INNER_ALERT = (By.CSS_SELECTOR, "div[class*=\"alert\"]:first-child div[class*=\"alertinner\"] strong")
